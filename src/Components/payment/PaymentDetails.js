        ...
        <div className="payment-details">
            <div className="card">
                <div className="header">
                    ...
                    <h3>CRWN Clothing Ltd.</h3>
                    <p>Your total is ₦{props.total}</p>
                    <span className='cancel' onClick={()=>dispatch(changeVisibility())}>&#10005;</span>
                </div>
                <div className="form">
                    <label htmlFor="name">NAME</label><br />
                    <input name='name' id='name' type="text" value={inputs.name} onChange={handleChange} /><br />
                    <label htmlFor="email">EMAIL</label><br />
                    <input name='email' id='email' type="email" value={inputs.email} onChange={handleChange} /><br />
                    <label htmlFor="phone">PHONE</label><br />
                    <input name='phone' id='phone' type="phone" value={inputs.phone} onChange={handleChange} />
